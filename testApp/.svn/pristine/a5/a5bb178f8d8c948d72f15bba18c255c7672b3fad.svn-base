...
/*
 *
 * @ Funkcija pomocu koje se proverava validnost pozicije trenutno proveravanog 'piksela'. Parametri funkcije su pozicija
 *   pocetnog 'piksela', velicina 'ulazne slike' i trenutna udaljenost od pocetnog 'piksela' po sirini odnosno visini.
 */
